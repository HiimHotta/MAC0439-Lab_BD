...
ALTER TABLE impressora ALTER cor SET DEFAULT FALSE;
...
insert into impressora (modelo, cor, tipo, preco) values (3001, true,  'ink-jet',  231);
insert into impressora (modelo, cor, tipo, preco) values (3002, true,  'ink-jet',  267);
insert into impressora (modelo, cor, tipo, preco) values (3003, false,   'laser',  390);
insert into impressora (modelo, cor, tipo, preco) values (3004, true,  'ink-jet',  439);
insert into impressora (modelo, cor, tipo, preco) values (3005, true,   'bubble',  200);
insert into impressora (modelo, cor, tipo, preco) values (3006, true,    'laser', 1999);
insert into impressora (modelo, cor, tipo, preco) values (3007, false,   'laser',  350);
